...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[var(--surface)] to-[var(--surface-muted)] border-r border-[var(--border)] flex-col items-center justify-center p-12">
        <div className="max-w-md space-y-8 text-center">
          ...
          <div className="space-y-6 pt-8">
            <div className="flex items-start gap-4 text-left">
              <div className="w-12 h-12 rounded-full bg-[var(--accent)] flex items-center justify-center text-2xl flex-shrink-0">
                🎮
              </div>
              <div>
                <h3 className="font-semibold text-[var(--text)]">Gamified Learning</h3>
                <p className="text-sm text-[var(--text-muted)]">
                  Earn XP, unlock achievements, and level up as you master Java Spring
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 text-left">
              ...
              <div>
                <h3 className="font-semibold text-[var(--text)]">Interactive Coding</h3>
                <p className="text-sm text-[var(--text-muted)]">
                  Write and execute code directly in your browser with instant feedback
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 text-left">
              ...
              <div>
                <h3 className="font-semibold text-[var(--text)]">Track Progress</h3>
                <p className="text-sm text-[var(--text-muted)]">
                  Monitor your streak, compete with others, and celebrate milestones
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium mb-2 text-[var(--text)]">
                Password
              </label>
              <input
                id="password"
