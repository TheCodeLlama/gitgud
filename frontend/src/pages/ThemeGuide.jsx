      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6 space-y-4">
            <div className="flex flex-wrap gap-4">
              <button className="inline-flex items-center justify-center px-6 h-10 rounded-md bg-transparent text-[var(--accent)] border-2 border-[var(--accent)] hover:bg-[var(--accent)] hover:text-[var(--bg)] font-medium transition-colors">
                Primary Action
              </button>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-lg p-6 space-y-4 max-w-md">
            ...
            <button className="w-full h-10 rounded-md bg-transparent text-[var(--accent)] border-2 border-[var(--accent)] hover:bg-[var(--accent)] hover:text-[var(--bg)] font-medium transition-colors">
              Sign In
            </button>
          </div>
        </section>
