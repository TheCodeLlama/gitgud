        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            <Link to="/" className="flex items-center mb-4">
              ...
              <span className="ml-2 text-lg font-semibold text-[var(--text)]">GitGud</span>
            </Link>
            <p className="text-sm text-[var(--text-muted)] mb-4">
              Level up your Java and Spring Boot skills through gamified learning.
            </p>
          ...
          {/* Links sections */}
          <div>
            <h3 className="text-sm font-semibold text-[var(--text)] mb-4">Product</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-[var(--text)] mb-4">Resources</h3>
            <ul className="space-y-2">
